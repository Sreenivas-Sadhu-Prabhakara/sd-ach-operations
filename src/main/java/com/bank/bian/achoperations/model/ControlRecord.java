package com.bank.bian.achoperations.model;
...
/**
 * The BIAN control record for this service domain: "ACH Batch Operating Session".
 *
 ...
 * to its asset type (ACH Batch). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "ACH Batch Operating Session";
